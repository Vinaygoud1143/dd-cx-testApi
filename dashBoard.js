...
getFiles("./results").then(function(ff) {
    ...
    stream.once("open", function(fd) {
        ...
        fs.readFile('./BUILD_TAG_NUM.txt', 'utf8', function(err, contents) {
            ...
            var logo = '<table style="width:100%;position: absolute;top: 0%;"><tr><td width:10%"><img src="http://flossdental.com/wp-content/uploads/2017/10/delta-dental-plans-association_logo_5829-1024x205.jpg" height="100" width="180"></img></td><td width:70%><h4 style="font-family: Georgia; color:#3366CC;">TEST AUTOMATION RESULTS' + buildno + '<h4><h2 style="font-family: Arial; color:#AF7AC5;">' + 'LAST UPDATED AT:- ' + (moment().format('lll')).toString().toUpperCase() + '</h2></td><td width:10%"><img src="https://www.hcltech.com/sites/default/files/styles/large/public/images/guideline_based1.png?itok=JdASqCkG" height="100" width="180"></img></td></tr>';
            var html =
                "<!DOCTYPE html>" +
                "<html>" +
                "<head>" +
                ...
                "<center><div id='piechart' style='position: absolute;left: 65%;right: 5%;top: 15%;'></div></center>" +
                ...
                "<table id ='suitedata' width='600' style='border: 1px solid black';'><tbody>" +
