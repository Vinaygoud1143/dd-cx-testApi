...
var TestData         = require('../../../testData/devEng/' + testDataEnv + '/claimsAPI/Primary_Adult_ChildMemberViewingOthersClaims.json');
var TestDescriptions = require('../../../descriptions/devEng/claimsAPI/Primary_Adult_ChildMemberViewingOthersClaims_desc.json');

// Claims Enrollee Service API giving "Enrollee-ID" and response body with "claims enrollee service details JSON data set".
describe('Claims Enrollee Service API - Primary & Adult & Child Member viewing Others Claim Details:  ', function() {
