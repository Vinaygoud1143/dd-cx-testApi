...
var TestData         = require('../../../testData/devEng/' + testDataEnv + '/claimsAPI/PrimaryAdultMemberViewingHisChildClaims.json');
var TestDescriptions = require('../../../descriptions/devEng/claimsAPI/PrimaryAdultMemberViewingHisChildClaims_desc.json');

// Claims Enrollee Service API giving "Enrollee-ID" and response body with "claims enrollee service details JSON data set".
describe('Claims Enrollee Service API - Primary Adult Member viewing Child Claim Details:  ', function() {
