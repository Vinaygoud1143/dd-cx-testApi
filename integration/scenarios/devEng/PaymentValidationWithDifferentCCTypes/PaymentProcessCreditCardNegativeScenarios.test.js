...
var TestData = require('../../../testData/devEng/' + testDataEnv + '/PaymentValidationWithDifferentCCTypes/PaymentProcessCreditCardNegativeScenarios.json');
var TestDescriptions = require('../../../descriptions/devEng/PaymentValidationWithDifferentCCTypes/PaymentProcessCreditCardNegativeScenarios_desc.json');

// Payment Service POSTing Different Types CreditCard Information For Negative Scenarios
describe('Process Payment API for Invalid CreditCard Payment Request - Making Payment with Different Types CreditCard details in Negative Scenarios :  ', function() {
